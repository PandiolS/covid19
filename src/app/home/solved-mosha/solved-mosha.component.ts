...
@Component({
  selector: 'app-solved-mosha',
  templateUrl: './solved-mosha.component.html',
  styleUrls: ['./solved-mosha.component.css']
})
export class SolvedMoshaComponent implements OnInit {
  ...
  getData() {
    ...
    this.dataResult = this.local.sheruar_grupmoshe;
